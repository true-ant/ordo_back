# Generated by Django 3.2.6 on 2021-08-20 03:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("role", models.IntegerField(choices=[(0, "Owner"), (1, "Admin"), (2, "User")], default=2)),
                (
                    "groups",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("shipping_address_zipcode", models.CharField(blank=True, max_length=100, null=True)),
                (
                    "company",
                    apps.common.models.FlexibleForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="offices", to="accounts.company"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "office",
                    apps.common.models.FlexibleForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="offices", to="accounts.office"
                    ),
                ),
                (
                    "vendor",
                    apps.common.models.FlexibleForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="vendors", to="accounts.vendor"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "invite_status",
                    models.IntegerField(
                        choices=[(0, "Invite Sent"), (1, "Invite Approved"), (2, "Invite Declined")], default=0
                    ),
                ),
                ...
                (
                    "office",
                    apps.common.models.FlexibleForeignKey(
                        null=True, on_delete=django.db.models.deletion.CASCADE, to="accounts.office"
                    ),
                ),
                (
                    "user",
