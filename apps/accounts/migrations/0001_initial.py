    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', apps.common.models.FlexibleForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='companies', to='accounts.company')),
                ('vendor', apps.common.models.FlexibleForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='vendors', to='accounts.vendor')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='company',
            name='vendors',
            field=models.ManyToManyField(through='accounts.CompanyVendor', to='accounts.Vendor'),
        ),
    ]
