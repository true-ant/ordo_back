    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('office', apps.common.models.FlexibleForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='connected_vendors', to='accounts.office')),
                ('vendor', apps.common.models.FlexibleForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='connected_offices', to='accounts.vendor')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('dental_budget_type', models.CharField(choices=[('production', 'Adjusted Production'), ('collection', 'Collection')], default='production', max_length=10)),
                ('dental_total_budget', models.DecimalField(decimal_places=2, max_digits=10)),
                ('dental_percentage', models.DecimalField(decimal_places=2, max_digits=5)),
                ('dental_budget', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('dental_spend', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('office_budget_type', models.CharField(choices=[('production', 'Adjusted Production'), ('collection', 'Collection')], default='production', max_length=10)),
                ('office_total_budget', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
