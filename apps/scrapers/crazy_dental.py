...
class CrazyDentalScraper(Scraper):
    ...
    def login_proc(self):
        ...
        resp = self.reqsession.post('https://www.crazydentalprices.com/dc-dental/services/Account.Login.Service.ss?n=3&c=1075085', headers=headers, json=json_data)
        print(f'[INFO] Login Status : {resp.status_code}')

    def get_cart_products(self):
        resp = self.reqsession.get('https://www.crazydentalprices.com/dc-dental/services/LiveOrder.Service.ss?c=1075085&internalid=cart', headers=headers)
    ...
    def clear_cart(self):
        ...
        for cart_product in cart_products:
            ...
            resp = self.reqsession.delete(f'https://www.crazydentalprices.com/dc-dental/services/LiveOrder.Line.Service.ss?c=1075085&internalid={internalid}&n=3', headers=headers)
    ...
    def add_to_cart(self, products):
        ...
        resp = self.reqsession.post('https://www.crazydentalprices.com/dc-dental/services/LiveOrder.Line.Service.ss', headers=headers, json=data)
        print(f'[INFO] Add to Cart : {resp.status_code}')

    def checkout(self):
        resp = self.reqsession.get(f"https://www.crazydentalprices.com/dc-dental/checkout.environment.ssp?lang=en_US&cur=USD&X-SC-Touchpoint=checkout&cart-bootstrap=T&t={int(time.time()*1000)}", headers=headers)
        ...
        resp = self.reqsession.put(f'https://www.crazydentalprices.com/dc-dental/services/LiveOrder.Service.ss?internalid=cart&t={int(time.time()*1000)}&c=1075085&n=3', headers=headers, json=cart_json)
    ...
    def review_order(self, checkout_data):
        resp = self.reqsession.put(f'https://www.crazydentalprices.com/dc-dental/services/LiveOrder.Service.ss?internalid=cart&t={int(time.time()*1000)}&c=1075085&n=3', headers=headers, json=checkout_data)
    ...
    def place_order(self,order_data):
        ...
        resp = self.reqsession.post(f'https://www.crazydentalprices.com/dc-dental/services/LiveOrder.Service.ss?t={int(time.time()*1000)}&c=1075085&n=3', headers=headers, json=order_data)
