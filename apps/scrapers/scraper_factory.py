...
def get_task(scraper, scraper_name, test="login", **kwargs):
    ...
    if test == "login":
        ...
        tracking_number = vendor_order_product.tracking_number
    ...
    elif test == "track_product_from_fedex":
        tracking_number = "280191637997"
        return scraper.track_product_from_fedex(
            tracking_number=tracking_number,
        )
    elif test == "track_product_from_usps":
        tracking_number = "9400111899220505042529"
        return scraper.track_product_from_usps(
            tracking_number=tracking_number,
        )
    elif test == "track_product_from_ups":
