...
AS $$
    DECLARE
        last_id bigint;
    BEGIN
        INSERT INTO orders_product (name, description, category_id, updated_at, created_at, is_available_on_vendor, is_special_offer, vendors, child_count)
        SELECT name, description, category_id, NOW(), NOW(), TRUE, FALSE, '{}', 0
